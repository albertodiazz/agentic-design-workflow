...
async def import_from_stitch(
    ...
    try:
        ...
        # v06.9 default: no LLM structural planner. Build the Penpot operation
        ...
        result = {
            ...
            "strategy": {
                ...
                "execution": "queue_execute_code_v06_9_text_fidelity",
            },
    ...
    # v06.9 intentionally skips LLM visual diff. The authoritative diagnostic
    ...
    visual_diff_report: dict[str, Any] | None = make_visual_diff_status(
        "skipped", reason="replaced_by_source_to_penpot_trace_v06_9_text_fidelity"
    )
